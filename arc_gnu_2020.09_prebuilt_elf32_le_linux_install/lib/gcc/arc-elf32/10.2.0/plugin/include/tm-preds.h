/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/SCRATCH2/arcjenkins2/slaves/ru20-custom-arcgnu1-arcoss/workspace/arcoss_verification/arc_gnu_toolchain_release/arc_gnu_toolchain_release/gcc/gcc/config/arc/arc.md'.  */
...
extern int push_multi_operand (rtx, machine_mode);
extern int pop_multi_operand (rtx, machine_mode);
extern int arc_nonmemory_operand (rtx, machine_mode);
				      ...
				      bool *allows_reg, bool *allows_mem)
{
  if (c >= CONSTRAINT_CnL && c <= CONSTRAINT_C62)
    return;
  if (c >= CONSTRAINT_l && c <= CONSTRAINT_Rcc)
    {
      *allows_reg = true;
      return;
    }
