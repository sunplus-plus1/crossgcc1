...
#define MASK_NO_BRCC_SET (1U << 16)
#define MASK_NO_COND_EXEC (1U << 17)
#define MASK_DPFP_DISABLE_LRSR (1U << 18)
#define MASK_NOMPY_SET (1U << 19)
#define MASK_VOLATILE_CACHE_SET (1U << 20)
#define MASK_NORM_SET (1U << 21)
#define MASK_RF16 (1U << 22)
#define MASK_NO_SDATA_SET (1U << 23)
#define MASK_SIMD_SET (1U << 24)
#define MASK_0 (1U << 25)
#define MASK_SPFP_COMPACT_SET (1U << 26)
#define MASK_SPFP_FAST_SET (1U << 27)
#define MASK_SWAP_SET (1U << 28)
...
enum opt_code
{
  ...
  OPT_mA6 = 1599,                            /* -mA6 */
  OPT_mA7 = 1600,                            /* -mA7 */
  OPT_mARC600 = 1601,                        /* -mARC600 */
  OPT_mARC601 = 1602,                        /* -mARC601 */
  OPT_mARC700 = 1603,                        /* -mARC700 */
  OPT_mEA = 1604,                            /* -mEA */
  OPT_mRcq = 1605,                           /* -mRcq */
  OPT_mRcw = 1606,                           /* -mRcw */
  OPT_malign_call = 1607,                    /* -malign-call */
  OPT_mannotate_align = 1608,                /* -mannotate-align */
  OPT_marclinux = 1609,                      /* -marclinux */
  OPT_marclinux_prof = 1610,                 /* -marclinux_prof */
  OPT_margonaut = 1611,                      /* -margonaut */
  OPT_matomic = 1612,                        /* -matomic */
  OPT_mauto_modify_reg = 1613,               /* -mauto-modify-reg */
  OPT_mbarrel_shifter = 1614,                /* -mbarrel-shifter */
  OPT_mbbit_peephole = 1615,                 /* -mbbit-peephole */
  OPT_mbig_endian = 1616,                    /* -mbig-endian */
  OPT_mbitops = 1617,                        /* -mbitops */
  OPT_mbranch_index = 1618,                  /* -mbranch-index */
  OPT_mcase_vector_pcrel = 1619,             /* -mcase-vector-pcrel */
  OPT_mcmem = 1620,                          /* -mcmem */
  OPT_mcode_density = 1621,                  /* -mcode-density */
  OPT_mcode_density_frame = 1622,            /* -mcode-density-frame */
  OPT_mcompact_casesi = 1623,                /* -mcompact-casesi */
  OPT_mcpu_ = 1624,                          /* -mcpu= */
  OPT_mcrc = 1625,                           /* -mcrc */
  OPT_mdiv_rem = 1626,                       /* -mdiv-rem */
  OPT_mdpfp = 1627,                          /* -mdpfp */
  OPT_mdpfp_compact = 1628,                  /* -mdpfp-compact */
  OPT_mdpfp_fast = 1629,                     /* -mdpfp-fast */
  OPT_mdsp_packa = 1630,                     /* -mdsp-packa */
  OPT_mdvbf = 1631,                          /* -mdvbf */
  OPT_mea = 1632,                            /* -mea */
  OPT_mearly_cbranchsi = 1633,               /* -mearly-cbranchsi */
  OPT_mexpand_adddi = 1634,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1635,                          /* -mfpu= */
  OPT_mindexed_loads = 1636,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1637,               /* -mirq-ctrl-saved= */
  OPT_misize = 1638,                         /* -misize */
  OPT_mjli_always = 1639,                    /* -mjli-always */
  OPT_mlittle_endian = 1640,                 /* -mlittle-endian */
  OPT_mll64 = 1641,                          /* -mll64 */
  OPT_mlock = 1642,                          /* -mlock */
  OPT_mlong_calls = 1643,                    /* -mlong-calls */
  OPT_mlpc_width_ = 1644,                    /* -mlpc-width= */
  OPT_mlra = 1645,                           /* -mlra */
  OPT_mlra_priority_compact = 1646,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1647,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1648,             /* -mlra-priority-none */
  OPT_mmac_24 = 1649,                        /* -mmac-24 */
  OPT_mmac_d16 = 1650,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1651,                  /* -mmedium-calls */
  OPT_mmillicode = 1652,                     /* -mmillicode */
  OPT_mmixed_code = 1653,                    /* -mmixed-code */
  OPT_mmpy_option_ = 1654,                   /* -mmpy-option= */
  OPT_mmul32x16 = 1655,                      /* -mmul32x16 */
  OPT_mmul64 = 1656,                         /* -mmul64 */
  OPT_mmultcost_ = 1657,                     /* -mmultcost= */
  OPT_mno_brcc = 1658,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1659,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1660,                  /* -mno-dpfp-lrsr */
  OPT_mno_mpy = 1661,                        /* -mno-mpy */
  OPT_mno_volatile_cache = 1662,             /* -mno-volatile-cache */
  OPT_mnorm = 1663,                          /* -mnorm */
  OPT_mq_class = 1664,                       /* -mq-class */
  OPT_mrf16 = 1665,                          /* -mrf16 */
  OPT_mrgf_banked_regs_ = 1666,              /* -mrgf-banked-regs= */
  OPT_mrtsc = 1667,                          /* -mrtsc */
  OPT_msdata = 1668,                         /* -msdata */
  OPT_msimd = 1669,                          /* -msimd */
  OPT_msize_level_ = 1670,                   /* -msize-level= */
  OPT_msoft_float = 1671,                    /* -msoft-float */
  OPT_mspfp = 1672,                          /* -mspfp */
  OPT_mspfp_compact = 1673,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1674,                     /* -mspfp-fast */
  OPT_mswap = 1675,                          /* -mswap */
  OPT_mswape = 1676,                         /* -mswape */
  OPT_mtelephony = 1677,                     /* -mtelephony */
  OPT_mtp_regno_ = 1678,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1679,                 /* -mtp-regno=none */
  OPT_mtune_ = 1680,                         /* -mtune= */
  OPT_multcost_ = 1681,                      /* -multcost= */
  OPT_munalign_prob_threshold_ = 1682,       /* -munalign-prob-threshold= */
  OPT_munaligned_access = 1683,              /* -munaligned-access */
  OPT_mvolatile_cache = 1684,                /* -mvolatile-cache */
  OPT_mxy = 1685,                            /* -mxy */
  OPT_n = 1686,                              /* -n */
  OPT_name_sort = 1687,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1688,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1689,              /* -no-integrated-cpp */
  OPT_no_pie = 1690,                         /* -no-pie */
  OPT_nocpp = 1691,                          /* -nocpp */
  OPT_nodefaultlibs = 1692,                  /* -nodefaultlibs */
  OPT_nolibc = 1693,                         /* -nolibc */
  OPT_nophoboslib = 1694,                    /* -nophoboslib */
  OPT_nostartfiles = 1695,                   /* -nostartfiles */
  OPT_nostdinc = 1696,                       /* -nostdinc */
  OPT_nostdinc__ = 1697,                     /* -nostdinc++ */
  OPT_nostdlib = 1698,                       /* -nostdlib */
  OPT_o = 1699,                              /* -o */
  OPT_objects = 1700,                        /* -objects */
  OPT_p = 1701,                              /* -p */
  OPT_pass_exit_codes = 1702,                /* -pass-exit-codes */
  /* OPT_pedantic = 1703, */                 /* -pedantic */
  OPT_pedantic_errors = 1704,                /* -pedantic-errors */
  OPT_pg = 1705,                             /* -pg */
  OPT_pie = 1706,                            /* -pie */
  OPT_pipe = 1707,                           /* -pipe */
  OPT_print_file_name_ = 1708,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1709,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1710,          /* -print-multi-directory */
  OPT_print_multi_lib = 1711,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1712,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1713,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1714,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1715,               /* -print-prog-name= */
  OPT_print_search_dirs = 1716,              /* -print-search-dirs */
  OPT_print_sysroot = 1717,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1718,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1719,                    /* -print-value */
  OPT_quiet = 1720,                          /* -quiet */
  OPT_r = 1721,                              /* -r */
  OPT_remap = 1722,                          /* -remap */
  OPT_reverse_sort = 1723,                   /* -reverse-sort */
  OPT_s = 1724,                              /* -s */
  OPT_save_temps = 1725,                     /* -save-temps */
  OPT_save_temps_ = 1726,                    /* -save-temps= */
  OPT_shared = 1727,                         /* -shared */
  OPT_shared_libgcc = 1728,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1729,               /* -shared-libphobos */
  OPT_size_sort = 1730,                      /* -size-sort */
  /* OPT_specs = 1731, */                    /* -specs */
  OPT_specs_ = 1732,                         /* -specs= */
  OPT_static = 1733,                         /* -static */
  OPT_static_libasan = 1734,                 /* -static-libasan */
  OPT_static_libgcc = 1735,                  /* -static-libgcc */
  OPT_static_libgfortran = 1736,             /* -static-libgfortran */
  OPT_static_libgo = 1737,                   /* -static-libgo */
  OPT_static_liblsan = 1738,                 /* -static-liblsan */
  OPT_static_libmpx = 1739,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1740,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1741,               /* -static-libphobos */
  OPT_static_libstdc__ = 1742,               /* -static-libstdc++ */
  OPT_static_libtsan = 1743,                 /* -static-libtsan */
  OPT_static_libubsan = 1744,                /* -static-libubsan */
  OPT_static_pie = 1745,                     /* -static-pie */
  /* OPT_std_c__03 = 1746, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1747, */                /* -std=c++0x */
  OPT_std_c__11 = 1748,                      /* -std=c++11 */
  OPT_std_c__14 = 1749,                      /* -std=c++14 */
  OPT_std_c__17 = 1750,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1751, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1752, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1753, */                /* -std=c++20 */
  OPT_std_c__2a = 1754,                      /* -std=c++2a */
  OPT_std_c__98 = 1755,                      /* -std=c++98 */
  OPT_std_c11 = 1756,                        /* -std=c11 */
  OPT_std_c17 = 1757,                        /* -std=c17 */
  /* OPT_std_c18 = 1758, */                  /* -std=c18 */
  /* OPT_std_c1x = 1759, */                  /* -std=c1x */
  OPT_std_c2x = 1760,                        /* -std=c2x */
  /* OPT_std_c89 = 1761, */                  /* -std=c89 */
  OPT_std_c90 = 1762,                        /* -std=c90 */
  OPT_std_c99 = 1763,                        /* -std=c99 */
  /* OPT_std_c9x = 1764, */                  /* -std=c9x */
  OPT_std_f2003 = 1765,                      /* -std=f2003 */
  OPT_std_f2008 = 1766,                      /* -std=f2008 */
  OPT_std_f2008ts = 1767,                    /* -std=f2008ts */
  OPT_std_f2018 = 1768,                      /* -std=f2018 */
  OPT_std_f95 = 1769,                        /* -std=f95 */
  OPT_std_gnu = 1770,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1771, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1772, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1773,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1774,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1775,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1776, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1777, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1778, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1779,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1780,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1781,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1782,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1783, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1784, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1785,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1786, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1787,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1788,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1789, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1790, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1791,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1792, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1793, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1794, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1795, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1796, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1797,                     /* -std=legacy */
  OPT_symbol_ = 1798,                        /* -symbol= */
  OPT_symbolic = 1799,                       /* -symbolic */
  OPT_t = 1800,                              /* -t */
  OPT_time = 1801,                           /* -time */
  OPT_time_ = 1802,                          /* -time= */
  OPT_traditional = 1803,                    /* -traditional */
  OPT_traditional_cpp = 1804,                /* -traditional-cpp */
  OPT_tree_stats = 1805,                     /* -tree-stats */
  OPT_trigraphs = 1806,                      /* -trigraphs */
  OPT_type_stats = 1807,                     /* -type-stats */
  OPT_u = 1808,                              /* -u */
  OPT_undef = 1809,                          /* -undef */
  OPT_v = 1810,                              /* -v */
  OPT_version = 1811,                        /* -version */
  OPT_w = 1812,                              /* -w */
  OPT_wrapper = 1813,                        /* -wrapper */
  OPT_x = 1814,                              /* -x */
  OPT_z = 1815,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
