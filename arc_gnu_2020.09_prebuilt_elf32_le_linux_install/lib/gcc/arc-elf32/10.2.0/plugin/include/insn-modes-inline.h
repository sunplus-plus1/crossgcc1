...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_FP_GTmode: return 4;
    case E_CC_FP_GEmode: return 4;
    case E_CC_FP_ORDmode: return 4;
    case E_CC_FP_UNEQmode: return 4;
    case E_CC_FPXmode: return 4;
    case E_CC_FPUmode: return 4;
    case E_CC_FPUEmode: return 4;
    case E_CC_FPU_UNEQmode: return 4;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_FP_GTmode: return 1;
    case E_CC_FP_GEmode: return 1;
    case E_CC_FP_ORDmode: return 1;
    case E_CC_FP_UNEQmode: return 1;
    case E_CC_FPXmode: return 1;
    case E_CC_FPUmode: return 1;
    case E_CC_FPUEmode: return 1;
    case E_CC_FPU_UNEQmode: return 1;
    case E_BImode: return 1;
    case E_QImode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_FP_GTmode: return E_CC_FP_GTmode;
    case E_CC_FP_GEmode: return E_CC_FP_GEmode;
    case E_CC_FP_ORDmode: return E_CC_FP_ORDmode;
    case E_CC_FP_UNEQmode: return E_CC_FP_UNEQmode;
    case E_CC_FPXmode: return E_CC_FPXmode;
    case E_CC_FPUmode: return E_CC_FPUmode;
    case E_CC_FPUEmode: return E_CC_FPUEmode;
    case E_CC_FPU_UNEQmode: return E_CC_FPU_UNEQmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_FP_GTmode: return 4*BITS_PER_UNIT;
    case E_CC_FP_GEmode: return 4*BITS_PER_UNIT;
    case E_CC_FP_ORDmode: return 4*BITS_PER_UNIT;
    case E_CC_FP_UNEQmode: return 4*BITS_PER_UNIT;
    case E_CC_FPXmode: return 4*BITS_PER_UNIT;
    case E_CC_FPUmode: return 4*BITS_PER_UNIT;
    case E_CC_FPUEmode: return 4*BITS_PER_UNIT;
    case E_CC_FPU_UNEQmode: return 4*BITS_PER_UNIT;
    case E_BImode: return 1;
