...
#define HAVE_ATTR_is_sfunc 1
extern enum attr_is_sfunc get_attr_is_sfunc (rtx_insn *);
...
#define HAVE_ATTR_is_SIBCALL 1
extern enum attr_is_SIBCALL get_attr_is_SIBCALL (rtx_insn *);

#define HAVE_ATTR_is_NON_SIBCALL 1
extern enum attr_is_NON_SIBCALL get_attr_is_NON_SIBCALL (rtx_insn *);
...
#define HAVE_ATTR_delay_slot_present 1
extern enum attr_delay_slot_present get_attr_delay_slot_present (rtx_insn *);
...
#define HAVE_ATTR_cond 1
extern enum attr_cond get_attr_cond (rtx_insn *);
...
#define HAVE_ATTR_in_delay_slot 1
extern enum attr_in_delay_slot get_attr_in_delay_slot (rtx_insn *);

#define HAVE_ATTR_in_call_delay_slot 1
extern enum attr_in_call_delay_slot get_attr_in_call_delay_slot (rtx_insn *);

#define HAVE_ATTR_in_sfunc_delay_slot 1
extern enum attr_in_sfunc_delay_slot get_attr_in_sfunc_delay_slot (rtx_insn *);

#define HAVE_ATTR_cond_delay_insn 1
extern enum attr_cond_delay_insn get_attr_cond_delay_insn (rtx_insn *);

#define HAVE_ATTR_in_ret_delay_slot 1
extern enum attr_in_ret_delay_slot get_attr_in_ret_delay_slot (rtx_insn *);

#define HAVE_ATTR_cond_ret_delay_insn 1
extern enum attr_cond_ret_delay_insn get_attr_cond_ret_delay_insn (rtx_insn *);

#define HAVE_ATTR_annul_ret_delay_insn 1
extern enum attr_annul_ret_delay_insn get_attr_annul_ret_delay_insn (rtx_insn *);

#define HAVE_ATTR_tune 1
extern enum attr_tune get_attr_tune (void);

#define HAVE_ATTR_tune_arc700 1
extern enum attr_tune_arc700 get_attr_tune_arc700 (rtx_insn *);

#define HAVE_ATTR_tune_dspmpy 1
extern enum attr_tune_dspmpy get_attr_tune_dspmpy (void);

#define HAVE_ATTR_tune_store 1
extern enum attr_tune_store get_attr_tune_store (void);
